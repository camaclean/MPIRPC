...
struct wrapped_function_parts<R(Class::*)(Args...)>
{
    ...
    using storage_tuple_type = std::tuple<std::conditional_t<std::is_array<std::remove_reference_t<Args>>::value,std::remove_cv_t<std::remove_reference_t<Args>>,std::decay_t<std::remove_reference_t<Args>>>...>;
